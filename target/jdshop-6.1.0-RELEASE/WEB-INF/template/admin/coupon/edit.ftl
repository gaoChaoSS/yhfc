...
<head>
	...
	<title>${message("business.coupon.edit")} - Powered By JDSQ</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="couponForm" class="ajax-form form-horizontal" action="${base}/admin/coupon/update" method="post">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<input id="couponPrice" name="couponPrice" value="${coupon.couponPrice}" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<select name="storeId" class="selectpicker form-control" data-size="10">
										...
										[#list stores as store]
											<option value="${store.id}"[#if store == coupon.store] selected[/#if]>${store.name}</option>
										[/#list]
									</select>
									</div>
								</div>
