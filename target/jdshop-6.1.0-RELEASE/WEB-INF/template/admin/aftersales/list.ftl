...
<head>
	...
	<title>${message("admin.aftersales.list")} - Powered By JDSQ</title>
								...
								<div id="search" class="input-group">
									<div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											...
											<li[#if !page.searchProperty?? || page.searchProperty == "member.mobile"] [/#if] data-search-property="member.mobile">
									...
									<tbody>
										[#list page.content as aftersales]
											<tr>
												...
												<td>${aftersales.member.mobile}</td>
												<td>${aftersales.member.attributeValue1}</td>
