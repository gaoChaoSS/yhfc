						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9 col-sm-4">
										...
										[#list suppliers as supplier]
                                            <option value="${supplier.id}" title="${supplier.supplierName}">${supplier.supplierName}--(${supplier.position})</option>
										[/#list]
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<select name="storeIds" class="selectpicker form-control"  data-live-search="true" data-size="10" multiple>
										...
										[#list stores as store]
											<option value="${store.id}" title="${store.name}">${store.area.fullName}(${store.name})</option>
										[/#list]
									</select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="input-group">
											<input id="maxBuy" name="maxBuy" class="form-control" type="text" maxlength="9">
