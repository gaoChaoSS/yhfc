...
<aside id="mainSidebar" class="main-sidebar">
	...
	<div id="mainSidebarPanelGroup" class="panel-group">
		...
		<div class="panel panel-default">
			...
			[#--[@has_any_permissions_tag permissions = ["admin:supplier "]]
				[#if hasPermission]
				[/#if]
			[/@has_any_permissions_tag]--]
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="#supplierGroupPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("admin/supplier/.*")] aria-expanded="true"[/#if]>
								<i class="iconfont icon-form"></i>
								<span>${message("admin.mainSidebar.supplierGroup")}</span>
								<i class="iconfont icon-unfold"></i>
							</a>
						</h4>
					</div>
			...
			<div id="supplierGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/supplier/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">

						[#--[@has_permission_tag permission="admin:supplier"]
							[#if hasPermission]
							[/#if]
						[/@has_permission_tag]--]
								<li class="list-group-item[#if .main_template_name?matches("admin/supplier/.*")] active[/#if]">
									<a href="${base}/admin/supplier/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.supplier")}
									</a>
								</li>
	...
	<ul class="list-group">
		...
		[@has_permission_tag permission="admin:storeStatistic"]
			[#if hasPermission]
				<li class="list-group-item[#if .main_template_name?matches("admin/store_statistic/.*")] active[/#if]">
					<a href="${base}/admin/store_statistic/list">
						<i class="iconfont icon-baobiao-xianxing text-blue-light"></i>
						<span>店铺统计</span>
					</a>
				</li>
