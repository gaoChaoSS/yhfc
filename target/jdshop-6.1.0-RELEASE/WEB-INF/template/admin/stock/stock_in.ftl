...
<head>
	...
	<title>${message("business.stock.stockIn")} - Powered By JDSQ</title>
		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$skuSn.selectpicker({
					...
					ajax: {
						url: "${base}/admin/stock/sku_select",
						type: "GET",
						data: function() {
							return {
								keyword: "{{{q}}}"
				...
				$stockForm.validate({
					...
					submitHandler: function(form) {
						$(form).ajaxSubmit({
							successRedirectUrl: "${base}/admin/stock/log"
						});
					}
				});
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="stockForm" class="ajax-form form-horizontal" action="${base}/admin/stock/stock_in" method="post">
