					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<label class="col-xs-3 control-label" for="beginDate">${message("common.dateRange")}:</label>
								<div class="input-group" data-provide="datetimerangepicker" data-date-format="YYYY-MM-DD HH:mm">
									...
									<div class="input-group-btn">
										<button class="btn btn-default" type="button" data-toggle="dropdown">
											[#switch page.searchProperty]
												[#case "phone"]
													<span>${message("Order.consigneemobile")}</span>
													[#break /]
[#--												[#case "areaName"]--]
									...
									<tbody>
										[#list page.content as order]
											<tr>
												...
												<td>${order.member.attributeValue1}</td>
