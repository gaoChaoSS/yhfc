...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="supplierForm" class="form-horizontal" action="${base}/admin/supplier/save" method="post">
							...
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4" title="供应商名，或者公司名" data-toggle="tooltip">
										<input id="supplierName" name="supplierName" class="form-control" type="text" minlength="1" maxlength="200">
									</div>
								</div>
								[#--联系人名--]
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4" title="供应商联系人姓名" data-toggle="tooltip">
										<input id="name" name="name" class="form-control" type="text" minlength="1" maxlength="200">
									</div>
								</div>
								[#--联系人tel--]
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required" for="tel">${message("Supplier.tel")}:</label>
									<div class="col-xs-9 col-sm-4" title="请输入联系人的号码（11位）" data-toggle="tooltip">
										<input id="tel" name="tel" class="form-control" type="text" minlength="11" maxlength="11">
									</div>
								</div>
								[#--供应商地址--]
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4" title="供应商详细地址" data-toggle="tooltip">
										<input id="position" name="position" class="form-control" type="text" minlength="1" maxlength="200">
									</div>
								</div>
