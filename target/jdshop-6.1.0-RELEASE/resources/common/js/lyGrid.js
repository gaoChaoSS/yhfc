...
(function() {
	lyGrid = (function(params,callback) {
		var confs = {
			...
			pageNow : 'pageNumber',// 当前页码 或 当前第几页
							...
							if (String(l_tree.tree)=="true") {
								...
								if(CommonUtil.in_array(lt,colkey)){
									...
									if(String(l_tree.hide)=="true")
										img.src=rootPath+"/resources/common/images/tree/nolines_plus.gif";
									else
										img.src=rootPath+"/resources/common/images/tree/nolines_minus.gif";
