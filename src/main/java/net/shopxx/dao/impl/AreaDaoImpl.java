...
public class AreaDaoImpl extends BaseDaoImpl<Area, Long> implements AreaDao {
	...
	@Override
	public List<Area> getCurrentCity() {
		String jpql = "SELECT area FROM Area area WHERE area.grade=1 and area.fullName='四川省成都市' ";
		TypedQuery<Area> query1= entityManager.createQuery(jpql, Area.class);
