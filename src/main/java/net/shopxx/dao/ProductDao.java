...
public interface ProductDao extends BaseDao<Product, Long> {
	 ...
	 *	查询店铺下的分类是否含有商品信息
	 *  @Auther: Demaxiya
	 *  @Create: 2019-07-15 13:21
	 */
	List<Product> findByStoreAndCategory(Store store, List<ProductCategory> categories);

	/**
	 *  查询分类下是否有商品
	 *  @Auther: Demaxiya
	 *  @Create: 2019-07-15 14:04
	 */
    List<Product> findByStoreAndCategory(Store store, ProductCategory categorie);
	 ...
	 * @return
	 */
	List<BigInteger> findListBySupplierId(Long id);

    void updateSort(String sn , int sort);
}