...
import net.shopxx.util.BigDecimalSerialize_2;
...
public class Product extends BaseEntity<Long> {
	...
	@JsonSerialize(using = BigDecimalSerialize_2.class)
...
//	private net.shopxx.entity.Store store;
	...
	private Set<net.shopxx.entity.Store> stores = new HashSet<>();
	...
	public Set<net.shopxx.entity.Store> getStores() {
		return stores;
	}

	public void setStores(Set<net.shopxx.entity.Store> stores) {
		this.stores = stores;
	}
