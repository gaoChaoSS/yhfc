...
//	private Set<Product> products = new HashSet<>();
     ...
     */
    @Length(max = 300)
    private String sendDescDef;

    /***
     * 指定的发货说明
     */
    @Length(max = 300)
    private String specSendDesc;

    /***
     * 指定的发货时间
     */
    private Date specSendTime;
    ...
    public String getSendDescDef() {
        return sendDescDef;
    }

    public void setSendDescDef(String sendDescDef) {
        this.sendDescDef = sendDescDef;
    }

    public String getSpecSendDesc() {
        return specSendDesc;
    }

    public void setSpecSendDesc(String specSendDesc) {
        this.specSendDesc = specSendDesc;
    }

    public Date getSpecSendTime() {
        return specSendTime;
    }

    public void setSpecSendTime(Date specSendTime) {
        this.specSendTime = specSendTime;
    }
    ...
    public BigDecimal getBailPayable() {
        if (Status.APPROVED.equals(getStatus())) {
