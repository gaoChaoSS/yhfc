...
public class StoreServiceImpl extends BaseServiceImpl<Store, Long> implements StoreService {
	...
	@Override
	public List<Store> findList(Long areaId, String storeName){
		return storeDao.findList(areaId,storeName);
	}

	@Override
	public List<Store> findMeetStore(Double minlat,Double maxlat,Double minlng,Double maxlng){
		return storeDao.findMeetStore(minlat,maxlat,minlng,maxlng);
	}
