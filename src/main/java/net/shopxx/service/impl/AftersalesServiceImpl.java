...
public class AftersalesServiceImpl extends BaseServiceImpl<Aftersales, Long> implements AftersalesService {
	...
	@Override
	public void review(Aftersales aftersales, boolean passed,boolean storeConfirm) {
...
//		}
	...
	public List<Map<String, Object>> queryAfterSaleRecord(Long memberId , int page ,int length) {
		return aftersalesDao.queryAfterSaleRecord(memberId,page,length);
	}

	@Override
	public List<Map<String, Object>> queryAfterSaleRecordByOrderId(Long orderId) {
		return aftersalesDao.queryAfterSaleRecordByOrderId(orderId);
	}

	@Override
	public List<Map<String, Object>> queryRefundCause() {
		return aftersalesDao.queryRefundCause();
	}
	...
	public void saveAfterSale(String afterSaleId, Long memberId, String storeId, int status, String afterSaleCause, String des, String pic, Long orderId) {
		aftersalesDao.saveAfterSale(afterSaleId,memberId,storeId,status,afterSaleCause,des,pic,orderId);
	}

	@Override
	public void saveAfterSaleItems(String id, String orderItemId, String afterSaleId, int afterQuantity) {
		aftersalesDao.saveAfterSaleItems(id,orderItemId,afterSaleId,afterQuantity);
	}
