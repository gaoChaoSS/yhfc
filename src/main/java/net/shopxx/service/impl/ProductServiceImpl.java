...
public class ProductServiceImpl extends BaseServiceImpl<Product, Long> implements ProductService {
	 ...
	 */
	@Override
	public List<Product> findAllByIds(Long[] ids){
		return productDao.findByIds(ids);
	}

	@Override
	public List<Product> findByStoreAndCategory(Store store, List<ProductCategory> categories) {
		return productDao.findByStoreAndCategory(store,categories);
	}

	@Override
	public List<Product> findByStoreAndCategory(Store store, ProductCategory categorie) {
		return productDao.findByStoreAndCategory(store,categorie);
	}

	@Override
	public List<Product> findBindAllStore() {
		return productDao.findBindAllStore();
	}

	@Override
	public void deleteBySupplierId(Long id) {
		//查出对应产品
		List<BigInteger> list =productDao.findListBySupplierId(id);
		if(list != null){
			for (BigInteger i : list){
				super.delete(Long.valueOf(i.toString()));
			}
		}
	}
