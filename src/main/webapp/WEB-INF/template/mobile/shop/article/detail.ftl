...
<head>
	...
	[@seo type = "ARTICLE_DETAIL"]
		...
		[/#if]
		[#--<title>[#if article.seoTitle?has_content]${article.seoTitle}[#else]${seo.resolveTitle()}[/#if][#if showPowered] - Powered By JDSQ[/#if]</title>--]
	[/@seo]
...
<body class="shop article-detail">
	<header class="header-default" data-spy="scrollToFixed" style="display: none">
