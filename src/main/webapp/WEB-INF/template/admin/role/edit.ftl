...
<head>
	...
	<title>${message("admin.role.edit")} - Powered By JDSQ</title>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10 permissions">
								<div class="checkbox checkbox-inline">
									<input id="storeStatistic" name="permissions" type="checkbox" value="admin:storeStatistic">
									<label for="storeStatistic">店铺统计</label>
								</div>
								<div class="checkbox checkbox-inline">
