...
<head>
	...
	<title>${message("business.coupon.list")} - Powered By JDSQ</title>
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/coupon/add" data-redirect-url="${base}/admin/coupon/list">
									...
									<tbody>
										[#list page.content as coupon]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/coupon/generate?couponId=${coupon.id}" title="${message("business.coupon.generate")}" data-toggle="tooltip">
														<i class="iconfont icon-newshot"></i>
													</a>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/coupon/edit?couponId=${coupon.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
